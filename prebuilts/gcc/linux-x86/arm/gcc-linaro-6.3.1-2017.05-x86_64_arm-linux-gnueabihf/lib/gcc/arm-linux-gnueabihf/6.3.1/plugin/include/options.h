...
enum opt_code
{
  ...
  OPT_muclibc = 1225,                        /* -muclibc */
  OPT_munaligned_access = 1226,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1227,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1228,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1229,              /* -mword-relocations */
  OPT_n = 1230,                              /* -n */
  OPT_no_canonical_prefixes = 1231,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1232,              /* -no-integrated-cpp */
  OPT_no_pie = 1233,                         /* -no-pie */
  OPT_nocpp = 1234,                          /* -nocpp */
  OPT_nodefaultlibs = 1235,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1236,                   /* -nostartfiles */
  OPT_nostdinc = 1237,                       /* -nostdinc */
  OPT_nostdinc__ = 1238,                     /* -nostdinc++ */
  OPT_nostdlib = 1239,                       /* -nostdlib */
  OPT_o = 1240,                              /* -o */
  OPT_p = 1241,                              /* -p */
  ...
  OPT_profile = 1260,                        /* -profile */
  OPT_pthread = 1261,                        /* -pthread */
  OPT_quiet = 1262,                          /* -quiet */
  OPT_r = 1263,                              /* -r */
  OPT_rdynamic = 1264,                       /* -rdynamic */
  OPT_remap = 1265,                          /* -remap */
  OPT_s = 1266,                              /* -s */
  OPT_s_bc_abi = 1267,                       /* -s-bc-abi */
  OPT_save_temps = 1268,                     /* -save-temps */
  OPT_save_temps_ = 1269,                    /* -save-temps= */
  OPT_shared = 1270,                         /* -shared */
  OPT_shared_libgcc = 1271,                  /* -shared-libgcc */
  /* OPT_specs = 1272, */                    /* -specs */
  OPT_specs_ = 1273,                         /* -specs= */
  OPT_static = 1274,                         /* -static */
  OPT_static_libasan = 1275,                 /* -static-libasan */
  OPT_static_libgcc = 1276,                  /* -static-libgcc */
  OPT_static_libgcj = 1277,                  /* -static-libgcj */
  OPT_static_libgfortran = 1278,             /* -static-libgfortran */
  OPT_static_libgo = 1279,                   /* -static-libgo */
  OPT_static_liblsan = 1280,                 /* -static-liblsan */
  OPT_static_libmpx = 1281,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1282,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1283,               /* -static-libstdc++ */
  OPT_static_libtsan = 1284,                 /* -static-libtsan */
  OPT_static_libubsan = 1285,                /* -static-libubsan */
  /* OPT_std_c__03 = 1286, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1287, */                /* -std=c++0x */
  OPT_std_c__11 = 1288,                      /* -std=c++11 */
  OPT_std_c__14 = 1289,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1290, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1291, */                /* -std=c++1y */
  OPT_std_c__1z = 1292,                      /* -std=c++1z */
  OPT_std_c__98 = 1293,                      /* -std=c++98 */
  OPT_std_c11 = 1294,                        /* -std=c11 */
  /* OPT_std_c1x = 1295, */                  /* -std=c1x */
  /* OPT_std_c89 = 1296, */                  /* -std=c89 */
  OPT_std_c90 = 1297,                        /* -std=c90 */
  OPT_std_c99 = 1298,                        /* -std=c99 */
  /* OPT_std_c9x = 1299, */                  /* -std=c9x */
  OPT_std_f2003 = 1300,                      /* -std=f2003 */
  OPT_std_f2008 = 1301,                      /* -std=f2008 */
  OPT_std_f2008ts = 1302,                    /* -std=f2008ts */
  ...
  OPT_std_gnu__98 = 1312,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1313,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1314, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1315, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1316,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1317,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1318, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1319, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1320,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1321, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1322, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1323, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1324,                     /* -std=legacy */
  OPT_symbolic = 1325,                       /* -symbolic */
  OPT_t = 1326,                              /* -t */
  OPT_time = 1327,                           /* -time */
  OPT_time_ = 1328,                          /* -time= */
  OPT_tno_android_cc = 1329,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1330,                 /* -tno-android-ld */
  OPT_traditional = 1331,                    /* -traditional */
  OPT_traditional_cpp = 1332,                /* -traditional-cpp */
  OPT_trigraphs = 1333,                      /* -trigraphs */
  OPT_u = 1334,                              /* -u */
  OPT_undef = 1335,                          /* -undef */
  OPT_v = 1336,                              /* -v */
  OPT_version = 1337,                        /* -version */
  OPT_w = 1338,                              /* -w */
  OPT_wrapper = 1339,                        /* -wrapper */
  OPT_x = 1340,                              /* -x */
  OPT_z = 1341,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
