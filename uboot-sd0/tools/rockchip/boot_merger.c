...
static void printHelp(void)
{
	...
	printf("\n./tools/boot_merger --pack --verbose -c RK322A -1 "
	       "rkbin-sd0/rk322x_ddr_300MHz_v1.04.bin -2 "
	       "rkbin-sd0/rk32/rk322x_usbplug_v2.32.bin -d "
	       "rkbin-sd0/rk32/rk322x_ddr_300MHz_v1.04.bin -b "
	       "rkbin-sd0/rk32/rk322x_miniloader_v2.32.bin\n");
}
