...
IMAGE_FILE=$1
OUTPUT_DIR=$2
PACK_TOOL=../rkbin-sd0/tools/resource_tool
...
prepare()
{
	...
	if [ "$IMAGE_FILE" = '--help' -o "$IMAGE_FILE" = '-h' -o "$IMAGE_FILE" = '--h' ]; then
		...
		echo "Can't find '../rkbin-sd0/' Responsity, please download it before pack image!"
		echo "How to obtain? 3 ways:"
		echo "	1. Login your Rockchip gerrit account: \"Projects\" -> \"List\" -> search \"rk/rkbin-sd0\" Responsity"
